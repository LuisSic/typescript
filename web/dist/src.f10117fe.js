...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/views/Views.ts":[function(require,module,exports) {
"use strict";
...
},{"./Views":"src/views/Views.ts"}],"src/views/UserShow.ts":[function(require,module,exports) {
"use strict";
...
},{"./Views":"src/views/Views.ts"}],"src/views/UserEdit.ts":[function(require,module,exports) {
"use strict";
...
},{"./Views":"src/views/Views.ts","./UserForm":"src/views/UserForm.ts","./UserShow":"src/views/UserShow.ts"}],"src/models/Model.ts":[function(require,module,exports) {
"use strict";
...
},{}],"src/models/Collections.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  User.buildUserCollection = function () {
    return new Collections_1.Collection(rootUrl, function (json) {
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Attributes":"src/models/Attributes.ts","./ApiSync":"src/models/ApiSync.ts","./Eventing":"src/models/Eventing.ts","./Collections":"src/models/Collections.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
